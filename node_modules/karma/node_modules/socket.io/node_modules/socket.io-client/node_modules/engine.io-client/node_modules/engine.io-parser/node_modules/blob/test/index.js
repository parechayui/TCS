...
describe('blob', function() {
  if (!Blob) {
    ...
    it('should encode arraybuffers with right assets', function(done) {
    ...
    it('should encode typed arrays with right assets', function(done) {
      var ary = new Uint8Array(5);
      for (var i = 0; i < 5; i++) ary[i] = i;
      var b = new Blob([ary]);
      var fr = new FileReader();
    ...
    it('should encode sliced typed arrays with right assets', function(done) {
      var ary = new Uint8Array(5);
      for (var i = 0; i < 5; i++) ary[i] = i;
