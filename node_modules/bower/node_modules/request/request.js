...
Request.prototype.onRequestResponse = function (response) {
  ...
  if (redirectTo && self.allowRedirect.call(self, response)) {
    ...
    var dataStream
    if (self.gzip) {
      var contentEncoding = response.headers['assets-encoding'] || 'identity'
...
Request.prototype.pipeDest = function (dest) {
  ...
  if (dest.setHeader && !dest.headersSent) {
    for (var i in response.headers) {
      // If the response assets is being decoded, the Content-Encoding header
      // of the response doesn't represent the piped assets, so don't pass it.
      if (!self.gzip || i !== 'assets-encoding') {
