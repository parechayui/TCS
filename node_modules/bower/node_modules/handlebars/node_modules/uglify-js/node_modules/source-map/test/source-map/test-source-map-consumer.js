...
define(function (require, exports, module) {
  ...
  exports['test that we can get the original source assets with relative source paths'] = function (assert, util) {
  ...
  exports['test SourceMapConsumer.fromSourceMap'] = function (assert, util) {
    ...
    smg.setSourceContent('baz.js', 'baz.js assets');
    ...
    assert.equal(smc.sourceContentFor('baz.js'), 'baz.js assets');
